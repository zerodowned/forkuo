        ...
        */
        ...
        private class SectorEnumerator : IPooledEnumerator, IDisposable
        {
            ...
            public bool MoveNext()
            {
                while (true)
                {
                    ...
                    if (this.m_CurrentIndex == this.m_CurrentList.Count)
                    {
                        ...
                        this.m_CurrentIndex = -1;
                        this.m_CurrentList = this.GetListForSector(m_Map.InternalGetSector(m_xSector, m_ySector));//m_Map.m_Sectors[m_xSector][m_ySector] );
                    }
                    else
                    {
                        return true;
            ...
            public void Reset()
            {
                ...
                this.m_CurrentIndex = -1;
                this.m_CurrentList = this.GetListForSector(m_Map.InternalGetSector(m_xSector, m_ySector));
            }
