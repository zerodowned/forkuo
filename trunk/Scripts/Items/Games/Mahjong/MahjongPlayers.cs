...
namespace Server.Engines.Mahjong
{
    public class MahjongPlayers
    {
        ...
        public void SetPublic(int index, bool value)
        {
            ...
            this.SendTilesPacket(true, !m_Game.SpectatorVision);
        ...
        {
            if (this.IsInGamePlayer(m_DealerPosition))
                return;
        ...
        public void ResetScores(int value)
        {
            ...
            this.SendPlayersPacket(true, m_Game.ShowScores);
        ...
        {
            if (this.Dealer != null)
                this.SendLocalizedMessage(1062698, Dealer.Name); // ~1_name~ is assigned the dealer.
        }
