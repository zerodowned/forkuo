...
namespace Server.Multis
{
    public class ComponentVerification
    {
        ...
        public bool IsItemValid(int itemID)
        {
            ...
            return this.CheckValidity(m_ItemTable[itemID]);
        }
        ...
        public bool IsMultiValid(int multiID)
        {
            ...
            return this.CheckValidity(m_MultiTable[multiID]);
        }
        ...
        {
            this.LoadSpreadsheet(m_ItemTable, path, itemColumns);
        }

        private void LoadMultis(string path, params string[] multiColumns)
        {
            this.LoadSpreadsheet(m_MultiTable, path, multiColumns);
        }
