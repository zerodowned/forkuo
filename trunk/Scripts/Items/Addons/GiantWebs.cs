...
namespace Server.Items
{
    public class GiantWeb1 : BaseAddon
    {
        ...
        public GiantWeb1(Serial serial) : base(serial)
        {
        }
    ...
    public class GiantWeb2 : BaseAddon
    {
        ...
        public GiantWeb2(Serial serial) : base(serial)
        {
        }
    ...
    public class GiantWeb3 : BaseAddon
    {
        ...
        public GiantWeb3(Serial serial) : base(serial)
        {
        }
    ...
    public class GiantWeb4 : BaseAddon
    {
        ...
        public GiantWeb4(Serial serial) : base(serial)
        {
        }
    ...
    public class GiantWeb5 : BaseAddon
    {
        ...
        public GiantWeb5(Serial serial) : base(serial)
        {
        }
    ...
    public class GiantWeb6 : BaseAddon
    {
        ...
        public GiantWeb6(Serial serial) : base(serial)
        {
        }
