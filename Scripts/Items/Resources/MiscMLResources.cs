...
namespace Server.Items
{
    public class Blight : Item
    {
        ...
        public Blight(Serial serial) : base(serial)
        {
        }
    ...
    {
        [Constructable]
        public LuminescentFungi() : this(1)
        {
        }
        ...
        public LuminescentFungi(Serial serial) : base(serial)
        {
        }
    ...
    {
        [Constructable]
        public CapturedEssence() : this(1)
        {
        }

        [Constructable]
        public CapturedEssence(int amount) : base(0x318E)
        {
            this.Stackable = true;
            this.Amount = amount;
        }

        public CapturedEssence(Serial serial) : base(serial)
        {
        }
    ...
    {
        [Constructable]
        public EyeOfTheTravesty() : this(1)
        {
        }
        ...
        [Constructable]
        public EyeOfTheTravesty(int amount) : base(0x318D)
        {
            this.Stackable = true;
            this.Amount = amount;
        }

        public EyeOfTheTravesty(Serial serial) : base(serial)
        {
        }
    ...
    public class Corruption : Item
    {
        ...
        [Constructable]
        public Corruption(int amount) : base(0x3184)
        {
            this.Stackable = true;
            this.Amount = amount;
        }

        public Corruption(Serial serial) : base(serial)
        {
        }
    ...
    public class DreadHornMane : Item
    {
        ...
        [Constructable]
        public DreadHornMane(int amount) : base(0x318A)
        {
            this.Stackable = true;
            this.Amount = amount;
        }

        public DreadHornMane(Serial serial) : base(serial)
        {
        }
    ...
    public class ParasiticPlant : Item
    {
        ...
        [Constructable]
        public ParasiticPlant(int amount) : base(0x3190)
        {
            this.Stackable = true;
            this.Amount = amount;
        }

        public ParasiticPlant(Serial serial) : base(serial)
        {
        }
    ...
    public class Muculent : Item
    {
        ...
        [Constructable]
        public Muculent(int amount) : base(0x3188)
        {
            this.Stackable = true;
            this.Amount = amount;
        }

        public Muculent(Serial serial) : base(serial)
        {
        }
    ...
    public class DiseasedBark : Item
    {
        ...
        [Constructable]
        public DiseasedBark(int amount) : base(0x318B)
        {
            this.Stackable = true;
            this.Amount = amount;
        }

        public DiseasedBark(Serial serial) : base(serial)
        {
        }
    ...
    public class GrizzledBones : Item
    {
        ...
        [Constructable]
        public GrizzledBones(int amount) : base(0x318C)
        {
            this.Stackable = true;
            this.Amount = amount;
        }

        public GrizzledBones(Serial serial) : base(serial)
        {
        }
    ...
    {
        [Constructable]
        public LardOfParoxysmus() : this(1)
        {
        }
        ...
        [Constructable]
        public LardOfParoxysmus(int amount) : base(0x3189)
        {
            this.Stackable = true;
            this.Amount = amount;
        }

        public LardOfParoxysmus(Serial serial) : base(serial)
        {
        }
    ...
    public class PerfectEmerald : Item
    {
        ...
        [Constructable]
        public PerfectEmerald(int amount) : base(0x3194)
        {
            this.Stackable = true;
            this.Amount = amount;
        }

        public PerfectEmerald(Serial serial) : base(serial)
        {
        }
    ...
    public class DarkSapphire : Item
    {
        ...
        [Constructable]
        public DarkSapphire(int amount) : base(0x3192)
        {
            this.Stackable = true;
            this.Amount = amount;
        }

        public DarkSapphire(Serial serial) : base(serial)
        {
        }
    ...
    public class Turquoise : Item
    {
        ...
        [Constructable]
        public Turquoise(int amount) : base(0x3193)
        {
            this.Stackable = true;
            this.Amount = amount;
        }

        public Turquoise(Serial serial) : base(serial)
        {
        }
    ...
    public class EcruCitrine : Item
    {
        ...
        [Constructable]
        public EcruCitrine(int amount) : base(0x3195)
        {
            this.Stackable = true;
            this.Amount = amount;
        }

        public EcruCitrine(Serial serial) : base(serial)
        {
        }
    ...
    public class WhitePearl : Item
    {
        ...
        [Constructable]
        public WhitePearl(int amount) : base(0x3196)
        {
            this.Stackable = true;
            this.Amount = amount;
        }
    ...
    public class FireRuby : Item
    {
        ...
        [Constructable]
        public FireRuby(int amount) : base(0x3197)
        {
            this.Stackable = true;
            this.Amount = amount;
        }

        public FireRuby(Serial serial) : base(serial)
        {
        }
    ...
    public class BlueDiamond : Item
    {
        ...
        [Constructable]
        public BlueDiamond(int amount) : base(0x3198)
        {
            this.Stackable = true;
            this.Amount = amount;
        }
    ...
    public class BrilliantAmber : Item
    {
        ...
        [Constructable]
        public BrilliantAmber(int amount) : base(0x3199)
        {
            this.Stackable = true;
            this.Amount = amount;
        }

        public BrilliantAmber(Serial serial) : base(serial)
        {
        }
    ...
    public class Scourge : Item
    {
        ...
        [Constructable]
        public Scourge(int amount) : base(0x3185)
        {
            this.Stackable = true;
            this.Amount = amount;
            this.Hue = 150;
        ...
        public Scourge(Serial serial) : base(serial)
        {
        }
    ...
    public class Putrefication : Item
    {
        ...
        [Constructable]
        public Putrefication(int amount) : base(0x3186)
        {
            this.Stackable = true;
            this.Amount = amount;
            this.Hue = 883;
        ...
        public Putrefication(Serial serial) : base(serial)
        {
        }
    ...
    public class Taint : Item
    {
        ...
        [Constructable]
        public Taint(int amount) : base(0x3187)
        {
            this.Stackable = true;
            this.Amount = amount;
            this.Hue = 731;
        ...
        public Taint(Serial serial) : base(serial)
        {
        }
    ...
    public class PristineDreadHorn : Item
    {
        ...
        public PristineDreadHorn(Serial serial) : base(serial)
        {
        }
    ...
    public class SwitchItem : Item
    {
        ...
        [Constructable]
        public SwitchItem(int amount) : base(0x2F5F)
        {
            this.Stackable = true;
            this.Amount = amount;
        }

        public SwitchItem(Serial serial) : base(serial)
        {
        }
