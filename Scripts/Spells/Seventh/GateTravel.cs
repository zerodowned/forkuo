    ...
    public class GateTravelSpell : MagerySpell
    {
        ...
        public override void OnCast()
        {
            if (this.m_Entry == null)
                ...
                this.Effect(m_Entry.Location, m_Entry.Map, true);
        }
        ...
        public void Effect(Point3D loc, Map map, bool checkMulti)
        {
            ...
            else if (Core.SE && (this.GateExistsAt(map, loc) || this.GateExistsAt(Caster.Map, Caster.Location))) // SE restricted stacking gates
            {
