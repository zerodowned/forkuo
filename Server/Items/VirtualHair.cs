...
namespace Server
{
    public abstract class BaseHairInfo
    {
        ...
        protected BaseHairInfo(int itemid) : this(itemid, 0)
        {
        }
    ...
    {
        public HairInfo(int itemid) : base(itemid, 0)
        {
        }

        public HairInfo(int itemid, int hue) : base(itemid, hue)
        {
        }

        public HairInfo(GenericReader reader) : base(reader)
        {
        }
    ...
    {
        public FacialHairInfo(int itemid) : base(itemid, 0)
        {
        }

        public FacialHairInfo(int itemid, int hue) : base(itemid, hue)
        {
        }

        public FacialHairInfo(GenericReader reader) : base(reader)
        {
        }
    ...
    {
        public HairEquipUpdate(Mobile parent) : base(0x2E, 15)
        {
    ...
    {
        public FacialHairEquipUpdate(Mobile parent) : base(0x2E, 15)
        {
    ...
    {
        public RemoveHair(Mobile parent) : base(0x1D, 5)
        {
    ...
    {
        public RemoveFacialHair(Mobile parent) : base(0x1D, 5)
        {
