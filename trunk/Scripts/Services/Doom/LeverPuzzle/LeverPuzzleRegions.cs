...
namespace Server.Engines.Doom
{
    public class LampRoomRegion : BaseRegion
    {
        ...
        public LampRoomRegion(LeverPuzzleController controller) : base(null, Map.Malas, Region.Find(LeverPuzzleController.lr_Enter, Map.Malas), LeverPuzzleController.lr_Rect)
        {
    ...
    public class LeverPuzzleRegion : BaseRegion
    {
        ...
        public LeverPuzzleRegion(LeverPuzzleController controller, int[] loc) : base(null, Map.Malas, Region.Find(LeverPuzzleController.lr_Enter, Map.Malas), new Rectangle2D(loc[0],loc[1],1,1))
        {
            this.Controller = controller;
            this.Register();
        }
