...
namespace Server.Mobiles
{
    ...
    public class PlayerVendor : Mobile
    {
        ...
        public void CollectGold(Mobile to)
        {
            if (this.HoldGold > 0)
            {
                this.SayTo(to, "How much of the {0} that I'm holding would you like?", HoldGold.ToString());
        ...
        public int GiveGold(Mobile to, int amount)
        {
            ...
            {
                this.SayTo(to, "I'm sorry, but I'm only holding {0} gold for you.", HoldGold.ToString());
                return 0;
            }
