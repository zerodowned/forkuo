    ...
    public class BarGraphRenderer : ChartRenderer
    {
            ...
            if (labels.Length == values.Length) 
            {
                for (int i = 0; i < labels.Length; i++)
                {
                    ...
                    if (this._displayLegend) 
                    {
                        ...
                        float currentWidth = this.CalculateImgFontWidth(currentLbl, _legendFontSize, FontFamily);
                ...
                this.CalculateBarWidth(DataPoints.Count, _graphWidth);
        ...
        private void CalculateGraphDimension() 
        {
            ...
            for (int i = 0; i < this._yTickCount; i++)
            {
                ...
                float measured = this.CalculateImgFontWidth(tickString, _labelFontSize, FontFamily);
