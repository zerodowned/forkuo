...
namespace Server.Gumps
{
    ...
    public class AdminGump : Gump
    {
                ...
                case AdminGumpPage.Administer_WorldBuilding:
                    {
                        ...
                        this.AddButtonLabeled(20, 150, this.GetButtonID(3, 100), "Documentation");
                        this.AddButtonLabeled(220, 150, this.GetButtonID(3, 107), "Rebuild Categorization");
                ...
                case AdminGumpPage.Accounts:
                    {
                        if (this.m_List == null)
                        {
                            this.m_List = new ArrayList(); // new ArrayList( (ICollection)Accounts.GetAccounts() );
                ...
                case AdminGumpPage.AccountDetails_Access_ClientIPs:
                    {
                        ...
                        {
                            this.AddHtml(18, 243 + (i * 22), 114, 20, this.Color(m_List[index].ToString(), LabelColor32), false, false);
        ...
        public void AddAccountHeader()
        {
            ...
            this.AddButtonLabeled(200, 20, this.GetButtonID(5, 31), "View All: Inactive");
            this.AddButtonLabeled(200, 40, this.GetButtonID(5, 32), "View All: Banned");
            this.AddButtonLabeled(200, 60, this.GetButtonID(5, 26), "View All: Shared");
            this.AddButtonLabeled(200, 80, this.GetButtonID(5, 30), "View All: Empty");
