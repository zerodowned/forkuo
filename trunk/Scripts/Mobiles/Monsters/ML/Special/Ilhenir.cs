...
namespace Server.Mobiles
{
    ...
    public class Ilhenir : BaseChampion
    {
        ...
        public Ilhenir(Serial serial) : base(serial)
        {
        }
        ...
        {
            return this.GetSpawnPosition(Location, Map, range);
        }
        ...
        public virtual Point3D GetSpawnPosition(Point3D from, Map map, int range)
        {
            ...
            Point3D loc = new Point3D((this.RandomPoint(X)), (this.RandomPoint(Y)), this.Z);
    ...
    public class StainedOoze : Item
    {
        ...
        [Constructable]
        public StainedOoze() : this(false)
        {
        }

        [Constructable]
        public StainedOoze(bool corrosive) : base(0x122A)
        {
            this.Movable = false;
            this.Hue = 0x95;
        ...
        public StainedOoze(Serial serial) : base(serial)
        {
        }
