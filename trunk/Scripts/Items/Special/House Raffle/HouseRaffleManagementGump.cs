...
namespace Server.Gumps
{
    public class HouseRaffleManagementGump : Gump
    {
        ...
        public HouseRaffleManagementGump(HouseRaffleStone stone) : this(stone, SortMethod.Default, 0)
        {
        }
        ...
        public HouseRaffleManagementGump(HouseRaffleStone stone, SortMethod sort, int page) : base(40, 40)
        {
            ...
            this.AddHtml(145, 35, 250, 20, this.Color(m_Stone.FormatLocation(), LabelColor), false, false);

            this.AddHtml(45, 55, 100, 20, this.Color("Ticket Price:", LabelColor), false, false);
            this.AddHtml(145, 55, 250, 20, this.Color(m_Stone.FormatPrice(), LabelColor), false, false);

            this.AddHtml(45, 75, 100, 20, this.Color("Total Entries:", LabelColor), false, false);
            this.AddHtml(145, 75, 250, 20, this.Color(m_Stone.Entries.Count.ToString(), LabelColor), false, false);
