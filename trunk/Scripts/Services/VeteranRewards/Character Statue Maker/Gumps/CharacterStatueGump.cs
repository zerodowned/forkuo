...
namespace Server.Gumps
{
    public class CharacterStatueGump : Gump
    {
        ...
        public CharacterStatueGump(Item maker, CharacterStatue statue, Mobile owner) : base(60, 36)
        {
            ...
            this.AddHtmlLocalized(133, 61, 120, 20, 1076208 + (int)m_Statue.Pose, 0x77E, false, false);
            ...
            this.AddHtmlLocalized(133, 146, 120, 20, this.GetDirectionNumber(m_Statue.Direction), 0x77E, false, false);
            ...
            this.AddHtmlLocalized(133, 231, 120, 20, this.GetMaterialNumber(m_Statue.StatueType, m_Statue.Material), 0x77E, false, false);
