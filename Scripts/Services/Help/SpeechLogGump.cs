...
namespace Server.Engines.Help
{
    public class SpeechLogGump : Gump
    {
        ...
        public SpeechLogGump(Mobile player, SpeechLog log) : this(player, new List<SpeechLogEntry>(log))
        {
        }
        ...
        public SpeechLogGump(Mobile player, List<SpeechLogEntry> log, int page) : base(500, 30)
        {
