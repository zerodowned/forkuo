...
namespace Server.Spells.Necromancy
{
    public class PoisonStrikeSpell : NecromancerSpell
    {
        ...
        public void Target(Mobile m)
        {
            if (this.CheckHSequence(m))
            {
                ...
                */
                ...
                double damage = Utility.RandomMinMax((Core.ML ? 32 : 36), 40) * ((300 + (this.GetDamageSkill(Caster) * 9)) / 1000);
        ...
        private class InternalTarget : Target
        {
            ...
            public InternalTarget(PoisonStrikeSpell owner) : base(Core.ML ? 10 : 12, false, TargetFlags.Harmful)
            {
                this.m_Owner = owner;
            }
