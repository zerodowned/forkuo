...
namespace Server.Gumps
{
    ...
    public class HouseGump : Gump
    {
        ...
        public HouseGump(Mobile from, BaseHouse house) : base(20, 30)
        {
            ...
            {
                ArrayList lines = this.Wrap(m_House.Sign.GetName());
            ...
            this.AddHtml(320, 170, 50, 20, m_House.LockDownCount.ToString(), false, false);

            this.AddHtmlLocalized(20, 190, 275, 20, 1011238, false, false); // Maximum locked down items:
            this.AddHtml(320, 190, 50, 20, m_House.MaxLockDowns.ToString(), false, false);

            this.AddHtmlLocalized(20, 210, 275, 20, 1011239, false, false); // Number of secure containers:
            this.AddHtml(320, 210, 50, 20, m_House.SecureCount.ToString(), false, false);

            this.AddHtmlLocalized(20, 230, 275, 20, 1011240, false, false); // Maximum number of secure containers:
            this.AddHtml(320, 230, 50, 20, m_House.MaxSecures.ToString(), false, false);
            ...
            if (this.m_House.Public)
            {
                ...
                this.AddHtml(320, 305, 50, 20, m_House.Visits.ToString(), false, false);
            }
