...
namespace Server.Mobiles
{
    public class EtherealMount : Item, IMount, IMountItem, Engines.VeteranRewards.IRewardItem
    {
        ...
        public virtual bool Validate(Mobile from)
        {
            ...
            else if (this.m_IsRewardItem && !Engines.VeteranRewards.RewardSystem.CheckIsUsableBy(from, this, null))
            {
    ...
    public class EtherealReptalon : EtherealMount
    {
        ...
        [Constructable]
        public EtherealReptalon() : base(0x2d95, 0x3e90)
        {
        }

        public EtherealReptalon(Serial serial) : base(serial)
        {
        }
    ...
    public class ChargerOfTheFallen : EtherealMount
    {
        ...
        [Constructable]
        public ChargerOfTheFallen() : base(0x2D9C, 0x3E92)
        {
        }
