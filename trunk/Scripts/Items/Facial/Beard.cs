...
namespace Server.Items
{
    ...
    {
        private LongBeard() : this(0)
        {
        }

        private LongBeard(int hue) : base(0x203E, hue)
        {
        }
    ...
    {
        private ShortBeard() : this(0)
        {
        }

        private ShortBeard(int hue) : base(0x203f, hue)
        {
        }
    ...
    {
        private Goatee() : this(0)
        {
        }

        private Goatee(int hue) : base(0x2040, hue)
        {
        }
    ...
    {
        private Mustache() : this(0)
        {
        }

        private Mustache(int hue) : base(0x2041, hue)
        {
        }
    ...
    {
        private MediumShortBeard() : this(0)
        {
        }

        private MediumShortBeard(int hue) : base(0x204B, hue)
        {
        }
    ...
    {
        private MediumLongBeard() : this(0)
        {
        }

        private MediumLongBeard(int hue) : base(0x204C, hue)
        {
        }
    ...
    {
        private Vandyke() : this(0)
        {
        }

        private Vandyke(int hue) : base(0x204D, hue)
        {
        }
