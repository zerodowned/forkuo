    ...
    public class PreferencesGump : Gump
    {
        ...
        public PreferencesGump(Mobile from, Preferences prefs) : base(50, 50)
        {
            ...
            for (int i = 0; i < arenas.Count; ++i)
            {
                ...
                this.AddCheck(x + 3, y + 1, 9730, 9727, m_Entry.Disliked.Contains(name), i);
                x += 35;
        ...
        {
            this.AddBackground(m_ColumnX, 12, width, 20, 0x242C);
            this.AddImageTiled(m_ColumnX + 2, 14, width - 4, 16, 0x2430);

            if (name != null)
                this.AddBorderedText(m_ColumnX, 13, width, this.Center(name), 0xFFFFFF, 0);
