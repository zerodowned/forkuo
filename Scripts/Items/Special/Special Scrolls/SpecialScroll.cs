    ...
    public abstract class SpecialScroll : Item
    {
        ...
        public class InternalGump : Gump
        {
            ...
            public InternalGump(Mobile mobile, SpecialScroll scroll) : base(25, 50)
            {
                ...
                this.AddHtmlLocalized(40, 48, 387, 100, m_Scroll.Message, true, true);
                ...
                if (this.m_Scroll.Title != 0)
                    this.AddHtmlLocalized(40, 20, 260, 20, m_Scroll.Title, 0xFFFFFF, false, false);
                else
                    this.AddHtml(40, 20, 260, 20, m_Scroll.DefaultTitle, false, false);

                if (this.m_Scroll is StatCapScroll)
                    this.AddHtmlLocalized(310, 20, 120, 20, 1038019, 0xFFFFFF, false, false); // Power
                else
                    this.AddHtmlLocalized(310, 20, 120, 20, AosSkillBonuses.GetLabel(m_Scroll.Skill), 0xFFFFFF, false, false);
            }
