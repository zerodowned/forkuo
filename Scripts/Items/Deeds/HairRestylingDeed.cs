    ...
    public class HairRestylingDeed : Item
    {
        ...
        private class InternalGump : Gump
        {
            ...
            public InternalGump(Mobile from, HairRestylingDeed deed) : base(50, 50)
            {
                ...
                {
                    this.AddHtmlLocalized(LayoutArray[i][2], LayoutArray[i][3], (i == 1) ? 125 : 80, (i == 1) ? 70 : 35, (m_From.Female) ? RacialData[i][0] : RacialData[i][1], false, false);
                    if (this.LayoutArray[i][4] != 0)
                    {
                        this.AddBackground(LayoutArray[i][0], LayoutArray[i][1], 50, 50, 0xA3C);
                        this.AddImage(LayoutArray[i][4], LayoutArray[i][5], (m_From.Female) ? RacialData[i][4] : RacialData[i][5]);
                    }
                    this.AddButton(LayoutArray[i][6], LayoutArray[i][7], 0xFA5, 0xFA7, i, GumpButtonType.Reply, 0);
                }
            }
