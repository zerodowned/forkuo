...
namespace Server.Engines.Craft
{
    public class CraftGump : Gump
    {
        ...
        private CraftGump(Mobile from, CraftSystem craftSystem, BaseTool tool, object notice, CraftPage page) : base(40, 40)
        {
            ...
            this.AddBackground(0, 0, 530, 437, 5054);
            this.AddImageTiled(10, 10, 510, 22, 2624);
            this.AddImageTiled(10, 292, 150, 45, 2624);
            this.AddImageTiled(165, 292, 355, 45, 2624);
            this.AddImageTiled(10, 342, 510, 85, 2624);
            this.AddImageTiled(10, 37, 200, 250, 2624);
            this.AddImageTiled(215, 37, 305, 250, 2624);
            this.AddAlphaRegion(10, 10, 510, 417);
            ...
            this.AddHtmlLocalized(10, 302, 150, 25, 1044012, LabelColor, false, false); // <CENTER>NOTICES</CENTER>

            this.AddButton(15, 402, 4017, 4019, 0, GumpButtonType.Reply, 0);
            this.AddHtmlLocalized(50, 405, 150, 18, 1011441, LabelColor, false, false); // EXIT

            this.AddButton(270, 402, 4005, 4007, GetButtonID(6, 2), GumpButtonType.Reply, 0);
            this.AddHtmlLocalized(305, 405, 150, 18, 1044013, LabelColor, false, false); // MAKE LAST

            // Mark option
            if (craftSystem.MarkOption)
            {
                this.AddButton(270, 362, 4005, 4007, GetButtonID(6, 6), GumpButtonType.Reply, 0);
                this.AddHtmlLocalized(305, 365, 150, 18, 1044017 + (context == null ? 0 : (int)context.MarkOption), LabelColor, false, false); // MARK ITEM
            }
            // ****************************************
            ...
            {
                this.AddButton(15, 342, 4005, 4007, GetButtonID(6, 1), GumpButtonType.Reply, 0);
                this.AddHtmlLocalized(50, 345, 150, 18, 1044259, LabelColor, false, false); // SMELT ITEM
            }
            // ****************************************
            ...
            {
                this.AddButton(270, 342, 4005, 4007, GetButtonID(6, 5), GumpButtonType.Reply, 0);
                this.AddHtmlLocalized(305, 345, 150, 18, 1044260, LabelColor, false, false); // REPAIR ITEM
            }
            // ****************************************
            ...
            {
                this.AddButton(270, 382, 4005, 4007, GetButtonID(6, 8), GumpButtonType.Reply, 0);
                this.AddHtmlLocalized(305, 385, 150, 18, 1061001, LabelColor, false, false); // ENHANCE ITEM
            }
            // ****************************************
            ...
            if (craftSystem.CraftSubRes.Init)
            {
                ...
                if (nameNumber > 0)
                    this.AddHtmlLocalized(50, 365, 250, 18, nameNumber, resourceCount.ToString(), LabelColor, false, false);
                else
                    this.AddLabel(50, 362, LabelHue, String.Format("{0} ({1} Available)", nameString, resourceCount));
            }
            // ****************************************
            ...
            if (craftSystem.CraftSubRes2.Init)
            {
                ...
                if (nameNumber > 0)
                    this.AddHtmlLocalized(50, 385, 250, 18, nameNumber, resourceCount.ToString(), LabelColor, false, false);
                else
                    this.AddLabel(50, 385, LabelHue, String.Format("{0} ({1} Available)", nameString, resourceCount));
            }
            // ****************************************
        ...
        public void CreateResList(bool opt, Mobile from)
        {
            ...
            for (int i = 0; i < res.Count; ++i)
            {
                ...
                {
                    if (i > 0)
                        this.AddButton(485, 260, 4005, 4007, 0, GumpButtonType.Page, (i / 10) + 1);

                    this.AddPage((i / 10) + 1);

                    if (i > 0)
                        this.AddButton(455, 260, 4014, 4015, 0, GumpButtonType.Page, i / 10);
                    ...
                    this.AddHtmlLocalized(255, 263, 200, 18, (context == null || !context.DoNotColor) ? 1061591 : 1061590, LabelColor, false, false);
                }
