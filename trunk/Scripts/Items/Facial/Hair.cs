...
namespace Server.Items
{
    ...
    {
        private GenericHair(int itemID) : this(itemID, 0)
        {
        }

        private GenericHair(int itemID, int hue) : base(itemID, hue)
        {
        }
    ...
    {
        private Mohawk() : this(0)
        {
        }

        private Mohawk(int hue) : base(0x2044, hue)
        {
        }
    ...
    {
        private PageboyHair() : this(0)
        {
        }

        private PageboyHair(int hue) : base(0x2045, hue)
        {
        }
    ...
    {
        private BunsHair() : this(0)
        {
        }

        private BunsHair(int hue) : base(0x2046, hue)
        {
        }
    ...
    {
        private LongHair() : this(0)
        {
        }

        private LongHair(int hue) : base(0x203C, hue)
        {
        }
    ...
    {
        private ShortHair() : this(0)
        {
        }

        private ShortHair(int hue) : base(0x203B, hue)
        {
        }
    ...
    {
        private PonyTail() : this(0)
        {
        }

        private PonyTail(int hue) : base(0x203D, hue)
        {
        }
    ...
    public class Afro : Hair
    {
        ...
        private Afro(int hue) : base(0x2047, hue)
        {
        }
    ...
    {
        private ReceedingHair() : this(0)
        {
        }

        private ReceedingHair(int hue) : base(0x2048, hue)
        {
        }
    ...
    {
        private TwoPigTails() : this(0)
        {
        }

        private TwoPigTails(int hue) : base(0x2049, hue)
        {
        }
    ...
    {
        private KrisnaHair() : this(0)
        {
        }

        private KrisnaHair(int hue) : base(0x204A, hue)
        {
        }
