...
namespace Server.Items
{
    public class IcicleLargeSouth : Item
    {
        ...
        public IcicleLargeSouth(Serial serial) : base(serial)
        {
        }
    ...
    public class IcicleMedSouth : Item
    {
        ...
        public IcicleMedSouth(Serial serial) : base(serial)
        {
        }
    ...
    public class IcicleSmallSouth : Item
    {
        ...
        public IcicleSmallSouth(Serial serial) : base(serial)
        {
        }
    ...
    public class IcicleLargeEast : Item
    {
        ...
        public IcicleLargeEast(Serial serial) : base(serial)
        {
        }
    ...
    public class IcicleMedEast : Item
    {
        ...
        public IcicleMedEast(Serial serial) : base(serial)
        {
        }
    ...
    {
        [Constructable]
        public IcicleSmallEast() : base(0x4577)
        {
        }

        public IcicleSmallEast(Serial serial) : base(serial)
        {
        }
