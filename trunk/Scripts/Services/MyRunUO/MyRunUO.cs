    ...
    public class MyRunUO : Timer
    {
        ...
        public void CheckConnection()
        {
            if (m_Command == null)
            {
                ...
                if (Config.LoadDataInFile)
                {
                    this.m_OpSkills = this.GetUniqueWriter("skills", out m_SkillsPath);
                    this.m_OpLayers = this.GetUniqueWriter("layers", out m_LayersPath);
                    this.m_OpMobiles = this.GetUniqueWriter("mobiles", out m_MobilesPath);
