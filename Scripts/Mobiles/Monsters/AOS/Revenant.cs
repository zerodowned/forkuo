...
namespace Server.Mobiles
{
    public class Revenant : BaseCreature
    {
        ...
        public override void OnThink()
        {
            ...
            else if (this.Map != this.m_Target.Map || !this.InRange(m_Target, 15))
            {
            ...
            if (this.m_Target.Hidden && this.InRange(m_Target, 3) && DateTime.Now >= this.NextSkillTime && this.UseSkill(SkillName.DetectHidden))
            {
