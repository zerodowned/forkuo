...
namespace Server.Items
{
    public class CocoaLiquor : Item
    {
        ...
        [Constructable]
        public CocoaLiquor() : base(0x103F)
        {
            this.Hue = 0x46A;
        }

        public CocoaLiquor(Serial serial) : base(serial)
        {
        }
    ...
    public class SackOfSugar : Item
    {
        ...
        [Constructable]
        public SackOfSugar() : this(1)
        {
        }

        [Constructable]
        public SackOfSugar(int amount) : base(0x1039)
        {
            this.Hue = 0x461;
            this.Stackable = true;
            this.Amount = amount;
    ...
    public class CocoaButter : Item
    {
        ...
        [Constructable]
        public CocoaButter() : base(0x1044)
        {
            this.Hue = 0x457;
        }

        public CocoaButter(Serial serial) : base(serial)
        {
        }
    ...
    public class Vanilla : Item
    {
        ...
        [Constructable]
        public Vanilla() : this(1)
        {
        }

        [Constructable]
        public Vanilla(int amount) : base(0xE2A)
        {
            this.Hue = 0x462;
            this.Stackable = true;
            this.Amount = amount;
    ...
    public class CocoaPulp : Item
    {
        ...
        [Constructable]
        public CocoaPulp() : this(1)
        {
        }

        [Constructable]
        public CocoaPulp(int amount) : base(0xF7C)
        {
            this.Hue = 0x219;
            this.Stackable = true;
            this.Amount = amount;
        ...
        public CocoaPulp(Serial serial) : base(serial)
        {
        }
