...
namespace Server.Commands
{
    ...
    public class BatchGump : BaseGridGump
    {
        ...
        public void Render()
        {
            ...
            this.AddEntryHeader(9);
            this.AddEntryLabel(191, m_Batch.Scope == null ? "Select Scope" : m_Batch.Scope.Accessors[0]);
            ...
            this.AddEntryHeader(9);
            this.AddEntryText(202, 0, m_Batch.Condition);
            this.AddEntryHeader(9);
            this.AddNewLine();
            ...
            for (int i = 0; i < this.m_Batch.BatchCommands.Count; ++i)
            {
                ...
                this.AddImageTiled(CurrentX, CurrentY, 9, 2, 0x24A8);
                this.AddImageTiled(CurrentX, CurrentY + 2, 2, EntryHeight + OffsetSize + EntryHeight - 4, 0x24A8);
                this.AddImageTiled(CurrentX, CurrentY + EntryHeight + OffsetSize + EntryHeight - 2, 9, 2, 0x24A8);
                this.AddImageTiled(CurrentX + 3, CurrentY + 3, 6, EntryHeight + EntryHeight - 4 - OffsetSize, HeaderGumpID);
    ...
    public class BatchScopeGump : BaseGridGump
    {
        ...
        public void Render()
        {
            ...
            for (int i = 0; i < BaseCommandImplementor.Implementors.Count; ++i)
            {
                ...
                this.AddEntryLabel(20 + OffsetSize + 140, impl.Accessors[0]);
