...
namespace Server.Items
{
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            if (this.m_Active)
            {
                if (this.m_MapDest != null && this.m_PointDest != Point3D.Zero)
                    this.LabelTo(from, "{0} [{1}]", m_PointDest, m_MapDest);
                else if (this.m_MapDest != null)
                    this.LabelTo(from, "[{0}]", m_MapDest);
                else if (this.m_PointDest != Point3D.Zero)
                    this.LabelTo(from, m_PointDest.ToString());
            }
            else
            {
    ...
    public class TimeoutTeleporter : Teleporter
    {
        ...
        [Constructable]
        public TimeoutTeleporter() : this(new Point3D(0, 0, 0), null, false)
        {
        }

        [Constructable]
        public TimeoutTeleporter(Point3D pointDest, Map mapDest) : this(pointDest, mapDest, false)
        {
        }

        [Constructable]
        public TimeoutTeleporter(Point3D pointDest, Map mapDest, bool creatures) : base(pointDest, mapDest, creatures)
        {
        ...
        {
            this.StartTimer(m, m_TimeoutDelay);
        }
    ...
    public class TimeoutGoal : Item
    {
        ...
        public TimeoutGoal(Serial serial) : base(serial)
        {
        }
    ...
    public class ConditionTeleporter : Teleporter
    {
        ...
        public ConditionTeleporter(Serial serial) : base(serial)
        {
        }
