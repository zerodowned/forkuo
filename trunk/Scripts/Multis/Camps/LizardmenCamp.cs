...
{ 
    public class LizardmenCamp : BaseCamp
    {
        ...
        public override void AddComponents()
        {
            ...
            for (int i = 0; i < 4; i ++)
            { 
                this.AddMobile(Lizardmen, 6, Utility.RandomMinMax(-7, 7), Utility.RandomMinMax(-7, 7), 0);
            }
            ...
            this.AddMobile(m_Prisoner, 2, Utility.RandomMinMax(-2, 2), Utility.RandomMinMax(-2, 2), 0);
        }
