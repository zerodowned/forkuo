...
namespace Server.Items
{
    ...
    public class SnowGlobeOne : SnowGlobe
    {
        ...
        public SnowGlobeOne(Serial serial) : base(serial)
        {
        }
    ...
    public class SnowGlobeTwo : SnowGlobe
    {
        ...
        [Constructable]
        public SnowGlobeTwo() : this((SnowGlobeTypeTwo)Utility.Random(19))
        {
        }
        ...
        public SnowGlobeTwo(Serial serial) : base(serial)
        {
        }
    ...
    public class SnowGlobeThree : SnowGlobe
    {
        ...
        public SnowGlobeThree(Serial serial) : base(serial)
        {
        }
