...
namespace Server.Spells.Spellweaving
{
    public abstract class ArcanistSpell : Spell
    {
        ...
        public override bool CheckCast()
        {
            ...
            int mana = this.ScaleMana(RequiredMana);
        ...
        {
            double percent = (50 + 2 * (this.GetResistSkill(m) - this.GetDamageSkill(Caster))) / 100;	//TODO: According to the guide this is it.. but.. is it correct per OSI?
