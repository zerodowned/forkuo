...
namespace Server.Network
{
    ...
    {
        public ScreenEffect(ScreenEffectType type) : base(0x70, 28)
        {
    ...
    public sealed class ScreenFadeOut : ScreenEffect
    {
        ...
        public ScreenFadeOut() : base(ScreenEffectType.FadeOut)
        { 
        }
    }
    ...
    public sealed class ScreenFadeIn : ScreenEffect
    {
        ...
        public ScreenFadeIn() : base(ScreenEffectType.FadeIn)
        {
        }
    }
    ...
    public sealed class ScreenFadeInOut : ScreenEffect
    {
        ...
        public ScreenFadeInOut() : base(ScreenEffectType.FadeInOut)
        { 
        }
    }
    ...
    public sealed class ScreenLightFlash : ScreenEffect
    {
        ...
        public ScreenLightFlash() : base(ScreenEffectType.LightFlash)
        {
        }
    }
    ...
    public sealed class ScreenDarkFlash : ScreenEffect
    {
        ...
        public ScreenDarkFlash() : base(ScreenEffectType.DarkFlash)
        { 
        }
    }
    ...
    public sealed class DisplayGumpPacked : Packet, IGumpWriter
    {
        ...
        public DisplayGumpPacked(Gump gump) : base(0xDD)
        {
            this.m_Gump = gump;
        ...
        public void Flush()
        {
            this.EnsureCapacity(28 + (int)m_Layout.Length + (int)m_Strings.Length);
            ...
            this.WritePacked(m_Layout);

            this.m_Stream.Write((int)this.m_StringCount);

            this.WritePacked(m_Strings);
