    ...
    public class Tournament
    {
        ...
        public void Slice()
        {
            ...
            else if (this.m_Stage == TournamentStage.Fighting)
            {
                if (this.m_Undefeated.Count == 1)
                {
                    ...
                    {
                        if (this.m_EventController != null)
                            this.Alert("The tournament has completed!", String.Format("Team {0} has won!", m_EventController.GetTeamName(((TournyMatch)((PyramidLevel)m_Pyramid.Levels[0]).Matches[0]).Participants.IndexOf(winner))));
                        else if (this.m_TournyType == TournyType.RandomTeam)
                            this.Alert("The tournament has completed!", String.Format("Team {0} has won!", ((TournyMatch)((PyramidLevel)m_Pyramid.Levels[0]).Matches[0]).Participants.IndexOf(winner) + 1));
                        else if (this.m_TournyType == TournyType.RedVsBlue)
                            this.Alert("The tournament has completed!", String.Format("Team {0} has won!", ((TournyMatch)((PyramidLevel)m_Pyramid.Levels[0]).Matches[0]).Participants.IndexOf(winner) == 0 ? "Red" : "Blue"));
                        else
        ...
        public void Alert(params string[] alerts)
        {
            for (int i = 0; i < this.m_Arenas.Count; ++i)
                this.Alert((Arena)m_Arenas[i], alerts);
        }
