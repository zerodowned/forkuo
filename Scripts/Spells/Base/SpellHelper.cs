...
namespace Server.Spells
{
    ...
    public class SpellHelper
    {
        ...
        private class SpellDamageTimerAOS : Timer
        {
            ...
            public SpellDamageTimerAOS(Spell s, Mobile target, Mobile from, int damage, int phys, int fire, int cold, int pois, int nrgy, TimeSpan delay, DFAlgorithm dfa) : base(delay)
            {
                this.m_Target = target;
                this.m_From = from;
                this.m_Damage = damage;
    ...
    public class TransformTimer : Timer
    {
        ...
        public TransformTimer(Mobile from, ITransformationSpell spell) : base(TimeSpan.FromSeconds(spell.TickRate), TimeSpan.FromSeconds(spell.TickRate))
        {
            this.m_Mobile = from;
            this.m_Spell = spell;
