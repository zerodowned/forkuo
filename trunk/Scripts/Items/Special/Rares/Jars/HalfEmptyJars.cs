...
namespace Server.Items
{
    ...
    public class HalfEmptyJars : Item
    {
        ...
        public HalfEmptyJars(Serial serial) : base(serial)
        {
        }
    ...
    public class Jars2 : Item
    {
        ...
        public Jars2(Serial serial) : base(serial)
        {
        }
    ...
    public class Jars3 : Item
    {
        ...
        public Jars3(Serial serial) : base(serial)
        {
        }
    ...
    public class Jars4 : Item
    {
        ...
        public Jars4(Serial serial) : base(serial)
        {
        }
