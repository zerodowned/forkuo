...
namespace Server.Items
{
    public class RepairDeed : Item
    {
        private class RepairSkillInfo
        {
            ...
            public RepairSkillInfo(CraftSystem system, Type nearbyType, TextDefinition notNearbyMessage, TextDefinition name) : this(system, new Type[] { nearbyType }, notNearbyMessage, name)
            {
            }
