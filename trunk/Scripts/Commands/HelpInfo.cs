    ...
    public class HelpInfo
    {
        ...
        public class CommandListGump : BaseGridGump
        {
            ...
            public CommandListGump(int page, Mobile from, List<CommandInfo> list) : base(30, 30)
            {
                ...
                this.AddEntryHtml(160, this.Center(String.Format("Page {0} of {1}", m_Page + 1, (m_List.Count + EntriesPerPage - 1) / EntriesPerPage)));
                ...
                for (int i = this.m_Page * EntriesPerPage, line = 0; line < EntriesPerPage && i < this.m_List.Count; ++i, ++line)
                {
                    ...
                    if (from.AccessLevel >= c.AccessLevel)
                    {
                        if ((int)c.AccessLevel != last)
                        {
                            ...
                            this.AddEntryHtml(20 + OffsetSize + 160, this.Color(c.AccessLevel.ToString(), 0xFF0000));
                            this.AddEntryHeader(20);
                            line++;
                        }
                        ...
                        this.AddEntryHtml(20 + OffsetSize + 160, c.Name);
        ...
        public class CommandInfoGump : Gump
        {
            ...
            public CommandInfoGump(CommandInfo info) : this(info, 320, 200)
            {
            }
