...
namespace Server.Guilds
{
    public class GuildInfoGump : BaseGuildGump
    {
        ...
        public override void PopulateGump()
        {
            ...
            this.AddHtml(233, 84, 320, 26, guild.Name, false, false);
            ...
            {
                this.AddHtml(233, 118, 320, 26, guild.Alliance.Name, false, false);
            ...
            this.AddCheck(65, 370, 0xD2, 0xD3, player.DisplayGuildTitle, 0);
            ...
            this.AddHtmlLocalized(480, 373, 60, 26, 3006115, (m_IsResigning) ? 0x5000 : 0, false, false); // Resign
        }
