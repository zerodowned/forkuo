...
namespace Server.Engines.Craft
{
    public class CraftGumpItem : Gump
    {
        ...
        public CraftGumpItem(Mobile from, CraftSystem craftSystem, CraftItem craftItem, BaseTool tool) : base(40, 40)
        {
            ...
            this.AddImageTiled(10, 217, 150, 53, 2624);
            this.AddImageTiled(165, 132, 355, 80, 2624);
            this.AddImageTiled(10, 275, 155, 22, 2624);
            this.AddImageTiled(10, 302, 150, 53, 2624);
            this.AddImageTiled(165, 217, 355, 80, 2624);
            this.AddImageTiled(10, 360, 155, 22, 2624);
            ...
            this.AddHtmlLocalized(10, 192, 150, 22, 1044054, LabelColor, false, false); // <CENTER>SKILLS</CENTER>
            this.AddHtmlLocalized(10, 277, 150, 22, 1044055, LabelColor, false, false); // <CENTER>MATERIALS</CENTER>
            this.AddHtmlLocalized(10, 362, 150, 22, 1044056, LabelColor, false, false); // <CENTER>OTHER</CENTER>
            ...
            if (needsRecipe)
            {
                this.AddButton(270, 387, 4005, 4007, 0, GumpButtonType.Page, 0);
                this.AddHtmlLocalized(305, 390, 150, 18, 1044151, GreyLabelColor, false, false); // MAKE NOW
            }
            else
            {
                this.AddButton(270, 387, 4005, 4007, 1, GumpButtonType.Reply, 0);
                this.AddHtmlLocalized(305, 390, 150, 18, 1044151, LabelColor, false, false); // MAKE NOW
            }
            ...
            if (craftItem.UseAllRes)
                this.AddHtmlLocalized(170, 302 + (m_OtherCount++ * 20), 310, 18, 1048176, LabelColor, false, false); // Makes as many as possible at once
            ...
            * */
            ...
            if (needsRecipe)
                this.AddHtmlLocalized(170, 302 + (m_OtherCount++ * 20), 310, 18, 1073620, RedLabelColor, false, false); // You have not learned this recipe.
        }
        ...
        public void DrawItem()
        {
            ...
            this.AddItem(20, 50, CraftItem.ItemIDOf(type), m_CraftItem.ItemHue);

            if (this.m_CraftItem.IsMarkable(type))
            {
                this.AddHtmlLocalized(170, 302 + (m_OtherCount++ * 20), 310, 18, 1044059, LabelColor, false, false); // This item may hold its maker's mark
        ...
        public void DrawResource()
        {
            ...
            for (int i = 0; i < this.m_CraftItem.Resources.Count - (cropScroll ? 1 : 0) && i < 4; i++)
            {
                ...
                {
                    retainedColor = true;
                    this.AddHtmlLocalized(170, 302 + (m_OtherCount++ * 20), 310, 18, 1044152, LabelColor, false, false); // * The item retains the color of this material
            ...
            {
                this.AddHtmlLocalized(170, 219 + (m_CraftItem.Resources.Count * 20), 310, 18, 1044447, LabelColor, false, false);
                this.AddLabel(430, 219 + (m_CraftItem.Resources.Count * 20), LabelHue, "1");
            }

            if (cropScroll)
                this.AddHtmlLocalized(170, 302 + (m_OtherCount++ * 20), 360, 18, 1044379, LabelColor, false, false); // Inscribing scrolls also requires a blank scroll and mana.
        }
