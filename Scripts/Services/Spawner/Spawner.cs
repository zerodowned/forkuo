...
namespace Server.Mobiles
{
    public class Spawner : Item, ISpawner
    {
        ...
        [Constructable]
        public Spawner(string spawnName) : this(1, 5, 10, 0, 4, spawnName)
        {
        }

        [Constructable]
        public Spawner(int amount, int minDelay, int maxDelay, int team, int homeRange, string spawnName) : base(0x1f13)
        {
        ...
        public Spawner(int amount, TimeSpan minDelay, TimeSpan maxDelay, int team, int homeRange, List<string> spawnNames) : base(0x1f13)
        {
        ...
        {
            if (this.SpawnNamesCount > 0)
                this.Spawn(Utility.Random(SpawnNamesCount));
        }
