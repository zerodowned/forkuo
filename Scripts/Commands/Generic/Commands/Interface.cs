...
namespace Server.Commands.Generic
{
    ...
    public class InterfaceGump : BaseGridGump
    {
        ...
        public void Render()
        {
            ...
            this.AddEntryHtml(40 + (m_Columns.Length * 130) - 20 + ((m_Columns.Length - 2) * OffsetSize), this.Center(String.Format("Page {0} of {1}", m_Page + 1, (m_List.Count + EntriesPerPage - 1) / EntriesPerPage)));
            ...
            if (this.m_Columns.Length > 1)
            {
                ...
                for (int i = 0; i < this.m_Columns.Length; ++i)
                {
                    ...
                    this.AddEntryHtml(130 + (i == 0 ? 40 : 0), m_Columns[i]);
                }
    ...
    public class InterfaceItemGump : BaseGridGump
    {
        ...
        public void Render()
        {
            ...
            this.AddEntryButton(20, ArrowLeftID1, ArrowLeftID2, 1, ArrowLeftWidth, ArrowLeftHeight);
            this.AddEntryHtml(160, m_Item.GetType().Name);
            this.AddEntryHeader(20);

            this.AddNewLine();
            this.AddEntryHtml(20 + OffsetSize + 160, "Properties");
            this.AddEntryButton(20, ArrowRightID1, ArrowRightID2, 2, ArrowRightWidth, ArrowRightHeight);

            this.AddNewLine();
            this.AddEntryHtml(20 + OffsetSize + 160, "Delete");
            this.AddEntryButton(20, ArrowRightID1, ArrowRightID2, 3, ArrowRightWidth, ArrowRightHeight);

            this.AddNewLine();
            this.AddEntryHtml(20 + OffsetSize + 160, "Go there");
            this.AddEntryButton(20, ArrowRightID1, ArrowRightID2, 4, ArrowRightWidth, ArrowRightHeight);

            this.AddNewLine();
            this.AddEntryHtml(20 + OffsetSize + 160, "Move to target");
            this.AddEntryButton(20, ArrowRightID1, ArrowRightID2, 5, ArrowRightWidth, ArrowRightHeight);

            this.AddNewLine();
            this.AddEntryHtml(20 + OffsetSize + 160, "Bring to pack");
        ...
        public override void OnResponse(NetState sender, RelayInfo info)
        {
            ...
            switch ( info.ButtonID )
            {
                ...
                case 4: // Go there
                    {
                        this.m_From.SendGump(new InterfaceItemGump(this.m_From, this.m_Columns, this.m_List, this.m_Page, this.m_Item));
                        this.InvokeCommand(String.Format("Go {0}", m_Item.Serial.Value));
                        break;
                    }
    ...
    public class InterfaceMobileGump : BaseGridGump
    {
        ...
        public InterfaceMobileGump(Mobile from, string[] columns, ArrayList list, int page, Mobile mob) : base(30, 30)
        {
            this.m_From = from;
        ...
        public void Render()
        {
            ...
            this.AddEntryButton(20, ArrowLeftID1, ArrowLeftID2, 1, ArrowLeftWidth, ArrowLeftHeight);
            this.AddEntryHtml(160, m_Mobile.Name);
            this.AddEntryHeader(20);
            ...
            {
                this.AddNewLine();
                this.AddEntryHtml(20 + OffsetSize + 160, "Go to there");
                this.AddEntryButton(20, ArrowRightID1, ArrowRightID2, 4, ArrowRightWidth, ArrowRightHeight);

                this.AddNewLine();
                this.AddEntryHtml(20 + OffsetSize + 160, "Bring them here");
                this.AddEntryButton(20, ArrowRightID1, ArrowRightID2, 5, ArrowRightWidth, ArrowRightHeight);
            }
            ...
            if (this.m_From == this.m_Mobile || this.m_From.AccessLevel > this.m_Mobile.AccessLevel)
            {
                ...
                {
                    this.AddEntryHtml(20 + OffsetSize + 160, "Kill");
                    this.AddEntryButton(20, ArrowRightID1, ArrowRightID2, 7, ArrowRightWidth, ArrowRightHeight);
                }
                else
                {
                    this.AddEntryHtml(20 + OffsetSize + 160, "Resurrect");
            ...
            {
                this.AddNewLine();
                this.AddEntryHtml(20 + OffsetSize + 160, "Client");
        ...
        public override void OnResponse(NetState sender, RelayInfo info)
        {
            ...
            switch ( info.ButtonID )
            {
                ...
                case 4: // Go there
                    {
                        this.m_From.SendGump(new InterfaceMobileGump(this.m_From, this.m_Columns, this.m_List, this.m_Page, this.m_Mobile));
                        this.InvokeCommand(String.Format("Go {0}", m_Mobile.Serial.Value));
                        break;
                    }
