...
namespace Server.Factions
{
    ...
    public class FactionGuardAI : BaseAI
    {
        ...
        {
            if (this.m_Mobile.Deleted || this.m_Mobile.Int < 95 || this.CanDispel(m_Mobile) || this.m_Mobile.AutoDispel)
                return null;
        ...
        {
            this.Run((Direction)((int)m_Mobile.GetDirectionTo(m) - 4) & Direction.Mask);
        }
        ...
        public void Run(Direction d)
        {
            ...
            if (!this.DoMove(m_Mobile.Direction, true))
                this.OnFailedMove();
        }
        ...
        public override bool Think()
        {
            ...
            if (combatant == null || combatant.Deleted || !combatant.Alive || combatant.IsDeadBondedPet || !this.m_Mobile.CanSee(combatant) || !this.m_Mobile.CanBeHarmful(combatant, false) || combatant.Map != this.m_Mobile.Map)
            {
                ...
                if (this.AcquireFocusMob(m_Mobile.RangePerception, m_Mobile.FightMode, false, false, true))
                {
            ...
            if (this.m_Mobile.Spell == null && DateTime.Now >= this.m_Mobile.NextSpellTime)
            {
                ...
                if (combatant != null)
                {
                    ...
                    {
                        int strMod = this.GetStatMod(m_Guard, StatType.Str);
                        int dexMod = this.GetStatMod(m_Guard, StatType.Dex);
                        int intMod = this.GetStatMod(m_Guard, StatType.Int);
