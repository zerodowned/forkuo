...
namespace Server.Engines.Doom
{
    public class LeverPuzzleController : Item
    {
        ...
        public class RockTimer : Timer
        {
            ...
            public RockTimer(Mobile player, LeverPuzzleController Controller) : base(TimeSpan.Zero, TimeSpan.FromSeconds(.25))
            {
                this.Count = 0;
        ...
        public class LampRoomKickTimer : Timer
        {
            ...
            public LampRoomKickTimer(Mobile player) : base(TimeSpan.FromSeconds(.25))
            {
                this.m = player;
            }
        ...
        public class LampRoomTimer : Timer
        {
            ...
            public LampRoomTimer(LeverPuzzleController controller) : base(TimeSpan.FromSeconds(5.0), TimeSpan.FromSeconds(5.0))
            {
                this.level = 0;
                this.ticks = 0;
                this.m_Controller = controller;
