...
namespace Server.Gumps
{
    ...
    public class RewardOptionGump : Gump
    {
        ...
        public RewardOptionGump(IRewardOption option, int title) : base(60, 36)
        {
            ...
            {
                this.AddButton(19, 49 + i * 24, 0x845, 0x846, m_Options[i].ID, GumpButtonType.Reply, 0);
                this.AddHtmlLocalized(44, 47 + i * 24, 213, 20, m_Options[i].Cliloc, 0x7FFF, false, false); 
            }
        }
