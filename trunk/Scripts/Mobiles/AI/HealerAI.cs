    ...
    public class HealerAI : BaseAI
    {
        ...
        public override bool Think()
        {
            ...
            else
            {
                ...
                {
                    if (this.AcquireFocusMob(m_Mobile.RangePerception, FightMode.Weakest, false, true, false))
                    {
                        this.WalkMobileRange(m_Mobile.FocusMob, 1, false, 4, 7);
                    }
                    else
                    {
        ...
        private void ProcessTarget(Target targ, NeedDelegate[] func)
        {
            ...
            if (toHelp != null)
            {
                ...
                {
                    this.DoMove(m_Mobile.GetDirectionTo(toHelp) | Direction.Running);
                }
                else
                {
