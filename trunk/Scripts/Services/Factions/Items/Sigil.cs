    ...
    public class Sigil : BaseSystemController
    {
        ...
        public void Update()
        {
            ...
            if (this.m_Town == null)
                ...
                this.AssignName(m_Town.Definition.CorruptedSigilName);
            else
                this.AssignName(m_Town.Definition.SigilName);
        ...
        public override void OnSingleClick(Mobile from)
        {
            ...
            if (this.IsCorrupted)
            {
                if (this.m_Corrupted.Definition.SigilControl.Number > 0)
                    this.LabelTo(from, m_Corrupted.Definition.SigilControl.Number);
                else if (this.m_Corrupted.Definition.SigilControl.String != null)
                    this.LabelTo(from, m_Corrupted.Definition.SigilControl.String);
            }
            else
            {
