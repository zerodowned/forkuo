    ...
    public class StaffHistory : PersistableObject
    {
        ...
        public void Render(ObjectCollection objects)
        {
            lock (RenderLock)
            {
                ...
                objects.Add(this.GraphHourlyPages(m_Pages, PageResolution.None, "New pages by hour", "graph_new_pages_hr"));
                objects.Add(this.GraphHourlyPages(m_Pages, PageResolution.Handled, "Handled pages by hour", "graph_handled_pages_hr"));
                objects.Add(this.GraphHourlyPages(m_Pages, PageResolution.Deleted, "Deleted pages by hour", "graph_deleted_pages_hr"));
                objects.Add(this.GraphHourlyPages(m_Pages, PageResolution.Canceled, "Canceled pages by hour", "graph_canceled_pages_hr"));
                objects.Add(this.GraphHourlyPages(m_Pages, PageResolution.Logged, "Logged-out pages by hour", "graph_logged_pages_hr"));
