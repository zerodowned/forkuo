    ...
    public class DefAlchemy : CraftSystem
    {
        ...
        public override void InitCraftList()
        {
            ...
            if (Core.SE)
            {
                ...
                index = this.AddCraft(typeof(ConflagrationPotion), 1044109, 1072096, 55.0, 105.0, typeof(GraveDust), 1023983, 5, 1044253);
                this.AddRes(index, typeof(Bottle), 1044529, 1, 500315);
                this.SetNeededExpansion(index, Expansion.SE);
                index = this.AddCraft(typeof(GreaterConflagrationPotion), 1044109, 1072099, 65.0, 115.0, typeof(GraveDust), 1023983, 10, 1044253);
                this.AddRes(index, typeof(Bottle), 1044529, 1, 500315);
                this.SetNeededExpansion(index, Expansion.SE);
                // Confusion Blast Potions
                index = this.AddCraft(typeof(ConfusionBlastPotion), 1044109, 1072106, 55.0, 105.0, typeof(PigIron), 1023978, 5, 1044253);
                this.AddRes(index, typeof(Bottle), 1044529, 1, 500315);
                this.SetNeededExpansion(index, Expansion.SE);
                index = this.AddCraft(typeof(GreaterConfusionBlastPotion), 1044109, 1072109, 65.0, 115.0, typeof(PigIron), 1023978, 10, 1044253);
                this.AddRes(index, typeof(Bottle), 1044529, 1, 500315);
                this.SetNeededExpansion(index, Expansion.SE);
            }
        }
