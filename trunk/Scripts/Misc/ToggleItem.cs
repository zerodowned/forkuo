...
namespace Server.Items
{
    public class ToggleItem : Item
    {
        ...
        [Constructable]
        public ToggleItem(int inactiveItemID, int activeItemID) : this(inactiveItemID, activeItemID, false)
        {
        }

        [Constructable]
        public ToggleItem(int inactiveItemID, int activeItemID, bool playersCanToggle) : base(inactiveItemID)
        {
            this.Movable = false;
        ...
        public ToggleItem(Serial serial) : base(serial)
        {
        }
