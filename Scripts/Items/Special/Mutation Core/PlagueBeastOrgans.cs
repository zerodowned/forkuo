...
namespace Server.Items
{
    ...
    public class PlagueBeastMaidenOrgan : PlagueBeastOrgan
    {
        ...
        public override void FinishOpening(Mobile from)
        {
            ...
            if (this.BrainHue > 0)
                this.AddComponent(new PlagueBeastComponent(0x1CF0, BrainHue, true), 22, 29);
    ...
    public class PlagueBeastRockOrgan : PlagueBeastOrgan
    {
        ...
        public override void FinishOpening(Mobile from)
        {
            ...
            if (this.BrainHue > 0)
                this.AddComponent(new PlagueBeastComponent(0x1CF0, BrainHue, true), 1, 24); // 22, 29 
            else
                this.AddComponent(new PlagueBeastBlood(), -7, 24);
        }
    ...
    public class PlagueBeastRubbleOrgan : PlagueBeastOrgan
    {
        ...
        public override void Initialize()
        {
            ...
            this.AddComponent(new PlagueBeastComponent(0x3BB, Hue), 0, 0);
            this.AddComponent(new PlagueBeastComponent(0x3BA, Hue), 4, 6);
            this.AddComponent(new PlagueBeastComponent(0x3BA, Hue), -6, 17);

            int v = Utility.Random(4);

            this.AddComponent(new PlagueBeastVein(0x1B1B, v == 0 ? Hue : RandomHue(Hue)), -23, -3);
            this.AddComponent(new PlagueBeastVein(0x1B1C, v == 1 ? Hue : RandomHue(Hue)), 19, 4);
            this.AddComponent(new PlagueBeastVein(0x1B1B, v == 2 ? Hue : RandomHue(Hue)), 21, 27);
            this.AddComponent(new PlagueBeastVein(0x1B1B, v == 3 ? Hue : RandomHue(Hue)), 10, 40);
        }
        ...
        public override void FinishOpening(Mobile from)
        {
            ...
            if (this.BrainHue > 0)
                this.AddComponent(new PlagueBeastComponent(0x1CF0, BrainHue, true), -5, 22);
            else
                this.AddComponent(new PlagueBeastBlood(), -13, 25);
    ...
    public class PlagueBeastBackupOrgan : PlagueBeastOrgan
    {
        ...
        public override void FinishOpening(Mobile from)
        {
            ...
            this.AddComponent((PlagueBeastComponent)m_Gland, -4, 16);
        }
        ...
        public void OpenOrgan()
        {
            ...
            if (this.BrainHue > 0)
                this.AddComponent(new PlagueBeastComponent(0x1CF0, BrainHue, true), 55, 69);
        }
