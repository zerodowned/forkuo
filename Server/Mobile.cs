    ...
    public class Mobile : IEntity, IHued, IComparable<Mobile>, ISerializable, ISpawnable
    {
        ...
        */
        ...
        public Item Holding
        {
            ...
            set
            {
                if (this.m_Holding != value)
                {
                    ...
                    {
                        this.UpdateTotal(m_Holding, TotalType.Weight, -(m_Holding.TotalWeight + m_Holding.PileWeight));
        ...
        private class SleepTimer : Timer
        {
            ...
            public SleepTimer(Mobile m, TimeSpan duration) : base(duration)
            {
                this.Priority = TimerPriority.TwentyFiveMS;
                this._Mobile = m;
            }
        ...
        public virtual Mobile Combatant
        {
            ...
            set
            {
                ...
                if (this.m_Combatant != value && value != this)
                {
                    ...
                    if ((this.m_Combatant != null && !this.CanBeHarmful(m_Combatant, false)) || !this.Region.OnCombatantChange(this, old, this.m_Combatant))
                    {
                    ...
                    if (this.m_Combatant != null && this.CanBeHarmful(m_Combatant, false))
                    {
                        this.DoHarmful(m_Combatant);
        ...
        public virtual void UpdateTotal(Item sender, TotalType type, int delta)
        {
            ...
            switch( type )
            {
                ...
                case TotalType.Weight:
                    ...
                    this.OnWeightChange(m_TotalWeight - delta);
                    break;
            }
        }
        ...
        private class SimpleStateTarget<T> : Target
        {
            ...
            public SimpleStateTarget(int range, TargetFlags flags, bool allowGround, TargetStateCallback<T> callback, T state) : base(range, allowGround, flags)
            {
                this.m_Callback = callback;
                this.m_State = state;
            }
        ...
        public ContextMenu ContextMenu
        {
            ...
            set
            {
                ...
                if (this.m_ContextMenu != null)
                    this.Send(new DisplayContextMenu(m_ContextMenu));
            }
        }
        ...
        private class SimpleStatePrompt : Prompt
        {
            ...
            public SimpleStatePrompt(PromptStateCallback callback, object state) : this(callback, false, state)
            {
            }
        ...
        public virtual void GetContextMenuEntries(Mobile from, List<ContextMenuEntry> list)
        {
            ...
            if (from == this && this.Backpack != null && this.CanSee(Backpack) && this.CheckAlive(false))
        ...
        {
            this.PrivateOverheadMessage(MessageType.Regular, m_SpeechHue, ascii, text, to.NetState);
        }
        ...
        {
            this.PublicOverheadMessage(MessageType.Regular, m_SpeechHue, ascii, text);
        }

        public void Say(string text)
        {
            this.PublicOverheadMessage(MessageType.Regular, m_SpeechHue, false, text);
        }
        ...
        {
            this.PublicOverheadMessage(MessageType.Regular, m_SpeechHue, number, type, affix, args);
        }
        ...
        {
            this.PublicOverheadMessage(MessageType.Regular, m_SpeechHue, number, args);
        }

        public void Emote(string text)
        {
            this.PublicOverheadMessage(MessageType.Emote, m_EmoteHue, false, text);
        }
        ...
        {
            this.PublicOverheadMessage(MessageType.Emote, m_EmoteHue, number, args);
        }

        public void Whisper(string text)
        {
            this.PublicOverheadMessage(MessageType.Whisper, m_WhisperHue, false, text);
        }
        ...
        {
            this.PublicOverheadMessage(MessageType.Whisper, m_WhisperHue, number, args);
        }

        public void Yell(string text)
        {
            this.PublicOverheadMessage(MessageType.Yell, m_YellHue, false, text);
        }
        ...
        {
            this.PublicOverheadMessage(MessageType.Yell, m_YellHue, number, args);
        }
        ...
        public Map Map
        {
            ...
            set
            {
                ...
                if (this.m_Map != value)
                {
                    ...
                    {
                        if (this.m_Map != null)
                            this.Send(new ServerChange(this, m_Map));
        ...
        public void UpdateRegion()
        {
            ...
            if (newRegion != this.m_Region)
            {
                ...
                this.OnRegionChange(m_Region, newRegion);
            }
        }
        ...
        public BankBox BankBox
        {
            get
            {
                ...
                if (this.m_BankBox == null)
                    this.AddItem(m_BankBox = new BankBox(this));
        ...
        {
            if (from == this)
                this.Send(new SkillUpdate(m_Skills));
        }
        ...
        public virtual void OnSingleClick(Mobile from)
        {
            ...
            if (m_GuildClickMessage)
            {
                ...
                if (guild != null && (this.m_DisplayGuildTitle || (this.m_Player && guild.Type != GuildType.Regular)))
                {
                    ...
                    this.PrivateOverheadMessage(MessageType.Regular, SpeechHue, true, text, from.NetState);
                }
            }
