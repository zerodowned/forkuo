...
namespace Server.Guilds
{
    public class GuildMemberInfoGump : BaseGuildGump
    {
        ...
        public override void PopulateGump()
        {
            ...
            this.AddHtml(180, 53, 150, 26, m_Member.Name, false, false);
			
            this.AddHtmlLocalized(20, 80, 150, 26, 1062956, 0x0, true, false); // <i>Rank</i>
            this.AddHtmlLocalized(180, 83, 150, 26, m_Member.GuildRank.Name, 0x0, false, false);
			
            this.AddHtmlLocalized(20, 110, 150, 26, 1062953, 0x0, true, false); // <i>Guild Title</i>
            this.AddHtml(180, 113, 150, 26, m_Member.GuildTitle, false, false);
            ...
            this.AddHtmlLocalized(50, 153, 270, 26, (m_Member == player.GuildFealty && guild.Leader != m_Member) ? 1063082 : 1062996, 0x0, false, false); // Clear/Cast Vote For This Member
			
            this.AddBackground(20, 180, 150, 26, 0x2486);
            this.AddButton(25, 185, 0x845, 0x846, 1, GumpButtonType.Reply, 0);
            this.AddHtmlLocalized(50, 183, 110, 26, 1062993, (m_ToLeader) ? 0x990000 : 0, false, false); // Promote
            ...
            this.AddHtmlLocalized(210, 213, 110, 26, 1062997, (m_toKick) ? 0x5000 : 0, false, false); // Kick
        }
