...
namespace Server.Items
{
    public class ValentinesCard : Item
    {
        ...
        */
        ...
        public ValentinesCard(Serial serial) : base(serial)
        {
        }
    ...
    public class ValentinesCardSouth : ValentinesCard
    {
        ...
        public ValentinesCardSouth(Serial serial) : base(serial)
        {
        }
    ...
    public class ValentinesCardEast : ValentinesCard
    {
        ...
        public ValentinesCardEast(Serial serial) : base(serial)
        {
        }
