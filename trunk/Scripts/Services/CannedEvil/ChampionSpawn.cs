    ...
    public class ChampionSpawn : Item
    {
        ...
        public void OnSlice()
        {
            ...
            if (this.m_Champion != null)
            {
                ...
                {
                    this.RegisterDamageTo(m_Champion);

                    if (this.m_Champion is BaseChampion)
                        this.AwardArtifact(((BaseChampion)m_Champion).GetArtifact());
        ...
        {
            if (this.m_Active)
                this.LabelTo(from, "{0} (Active; Level: {1}; Kills: {2}/{3})", m_Type, Level, m_Kills, MaxKills);
            else
                this.LabelTo(from, "{0} (Inactive)", m_Type);
        }
                ...
                case 0:
                    {
                        ...
                        if (reader.ReadBool())
                        {
                            ...
                            this.BeginRestart(m_RestartTime - DateTime.Now);
                        }
