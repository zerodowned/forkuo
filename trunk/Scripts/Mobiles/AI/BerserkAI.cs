...
namespace Server.Mobiles
{
    public class BerserkAI : BaseAI
    {
        ...
        public override bool DoActionWander()
        {
            ...
            if (this.AcquireFocusMob(m_Mobile.RangePerception, FightMode.Closest, false, true, true))
            {
        ...
        public override bool DoActionCombat()
        {
            ...
            if (this.WalkMobileRange(m_Mobile.Combatant, 1, true, m_Mobile.RangeFight, m_Mobile.RangeFight))
            {
        ...
        {
            if (this.AcquireFocusMob(m_Mobile.RangePerception, m_Mobile.FightMode, false, true, true))
            {
                if (this.m_Mobile.Debug)
