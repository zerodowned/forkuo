...
namespace Server.Items
{
    public class SubtextSign : Sign
    {
        ...
        [Constructable]
        public SubtextSign(SignType type, SignFacing facing, string subtext) : base(type, facing)
        {
            this.m_Subtext = subtext;
        }

        [Constructable]
        public SubtextSign(int itemID, string subtext) : base(itemID)
        {
            this.m_Subtext = subtext;
        }
        ...
        public SubtextSign(Serial serial) : base(serial)
        {
        }
