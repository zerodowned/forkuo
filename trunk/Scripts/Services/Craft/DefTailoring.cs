...
namespace Server.Engines.Craft
{
    public class DefTailoring : CraftSystem
    {
        ...
        private static readonly Type[] m_TailorNonColorables = new Type[]
        {
            typeof(OrcHelm)
        };
