...
namespace Server.Items
{
    ...
    public class SnowStatuePegasus : Item
    {
        ...
        public SnowStatuePegasus(Serial serial) : base(serial)
        {
        }
    ...
    public class SnowStatueSeahorse : Item
    {
        ...
        public SnowStatueSeahorse(Serial serial) : base(serial)
        {
        }
    ...
    public class SnowStatueMermaid : Item
    {
        ...
        public SnowStatueMermaid(Serial serial) : base(serial)
        {
        }
    ...
    public class SnowStatueGriffon : Item
    {
        ...
        public SnowStatueGriffon(Serial serial) : base(serial)
        {
        }
    ...
    public class SnowStatueDeed : Item
    {
        ...
        [Constructable]
        public SnowStatueDeed() : base(0x14F0)
        {
            this.LootType = LootType.Blessed;
        }

        public SnowStatueDeed(Serial serial) : base(serial)
        {
        }
