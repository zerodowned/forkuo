...
namespace Server.Factions
{
    public class FactionImbueGump : FactionGump
    {
        ...
        { 
            ...
            this.AddHtmlLocalized(175, 60, 100, 25, 1018305 - m_Quality, false, false); //	Exceptional, Average, Low
            ...
            this.AddLabel(55, 140, m_Faction.Definition.HuePrimary - 1, "*****");
            this.AddHtmlLocalized(150, 140, 150, 25, 1011570, false, false); // Primary Color

            this.AddRadio(20, 160, 210, 211, false, 2);
            this.AddLabel(55, 160, m_Faction.Definition.HueSecondary - 1, "*****");
